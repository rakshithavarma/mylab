...
if(isset($_POST['save_datetime']))
{
    ...
    $query = "INSERT INTO assignments (teacher_id,section_id,class_id,subject_id,question,subdatetime) VALUES ('$tid','$sec_id' ,'$class_id','$subject_id','$name','$event_dt')";
    ...
    {
        echo "Assignment Not Inserted. Error:-(";
        header("Location: class_template-t.php?id=$class_id");
    }
}
?>